...
const Registerpage = () => {
  ...
  const handleRegisteration = async (e: { preventDefault: () => void; }) => {
  ...
  return (
    <main className="relative bg-black min-h-screen">
      ...
      {/* LOGO */}
      <h1 className="absolute top-0 lg:left-0 lg:m-4 font-bold text-2xl p-3 text-white">
        Logo
      </h1>
      ...
      <div className="absolute inset-0 bg-black bg-opacity-80 flex justify-center items-center">
        <div className="w-full lg:w-1/3 md:w-1/2 h-auto bg-transparent bg-opacity-40 flex flex-col gap-6 rounded-lg text-white p-8">
          <div className=" flex flex-col gap-3 text-center pb-5">
            ...
            <p>
              Register and become a part of an exclusive club. Fill in your
              required details and begin your journey.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <form className="flex flex-col gap-4 items-center justify-center w-full">
              ...
              <div className="flex justify-center items-center w-full">
                ...
                className="bg-blue-500 px-6 py-2 my-6 rounded-md text-white w-full">
                  Sign In
                </button>
              </div>
